...
* http://www.packetstormsecurity.org/sniffers/Sniffer_construction.txt
* 
* various enhancements and decoder part by Forth
* 	forth@ophane.net
* 
* may be freely distributed under the ISC licence
*/
